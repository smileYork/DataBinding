...
public class GreenDao {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Schema schema = new Schema(5, "com.jht.administrator.bean");

        schema.setDefaultJavaPackageDao("com.jht.administrator.dao");
        ...
        new DaoGenerator().generateAll(schema, "../DataBinding/app/src/main/java");
    }
    ...
    private static void addScore(Schema schema) {
        ...
        score.addIdProperty().autoincrement();

        score.addLongProperty("st_id");

        score.addDoubleProperty("score");

        score.addDateProperty("in_time");
